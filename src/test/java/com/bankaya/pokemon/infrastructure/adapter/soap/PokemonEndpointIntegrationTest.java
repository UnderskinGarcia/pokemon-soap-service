...
class PokemonEndpointIntegrationTest {
    ...
    void testSuccessfulEndpointRequests(String requestType, String pokemonName, String xpathExpression, String expectedValue) {
        ...
        if (expectedValue != null) {
            responseActions.andExpect(ResponseMatchers.xpath(xpathExpression, NAMESPACE_MAP).evaluatesTo(expectedValue));
        }
    }
    ...
    void testWsdlGeneration() {
        // This test verifies that the WSDL is properly generated
        // In a real integration test, you would call the /pokemon/ws/pokemon.wsdl endpoint
